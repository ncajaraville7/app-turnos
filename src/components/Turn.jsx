const Turn = () => {
    return (
        ...
        <p className="font-bold mb-3 text-gray-700 uppercase">Nombre:
            <span className="font-normal normal-case"> Fisuni</span> 
        </p>

        <p className="font-bold mb-3 text-gray-700 uppercase">Apellido:
            <span className="font-normal normal-case"> Cajaraville</span> 
        </p>

        <p className="font-bold mb-3 text-gray-700 uppercase">Teléfono:
            <span className="font-normal normal-case"> 1534993232</span> 
        </p>
        ...
        <p className="font-bold mb-3 text-gray-700 uppercase">Descripción:
            <span className="font-normal normal-case"> Cortesaki</span> 
        </p>
      </div>
    );
}
